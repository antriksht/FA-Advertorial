          ...
          <div className="mt-12 text-center">
            <p className="text-secondary-600 text-sm">
              *Individual results may vary. Testimonials are from actual clients who found advisors through our service.  
              You can also view our reviews on <a href="https://www.trustpilot.com/review/www.wiseradvisor.com" target="_blank" rel="noopener noreferrer" className="underline text-primary-600 hover:text-primary-700">Trustpilot here</a>.
            </p>
          </div>
        </div>
      </div>
